...
<html lang="en">
  <head>
    <title>Spartan Gym &mdash; Colorlib Website Template</title>
    <meta charset="utf-8">
      ...
      <div class="site-navbar-top">
        <div class="container py-2">
          <div class="row align-items-center">
            <div class="col-6">
              <a href="https://www.facebook.com/SPARTAN-GYM-2067914556839010/" class="p-2 pl-0"><span class="icon-facebook"></span></a>
              <a href="https://www.instagram.com/spartan_gym_palizzi_marina/?hl=it" class="p-2 pl-0"><span class="icon-instagram"></span></a>
            </div>
            <div class="col-6">
      ...
      <div class="container">
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="index.html">Spartan<strong>Gym</strong>  </a></h2>
              </div>
              <div class="col-10">
